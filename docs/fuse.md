...
FUSE (Filesystem in Userspace) lets NeuralFS expose a virtual filesystem tree without kernel-level code. The kernel forwards file operations (open/read/readdir) to the NeuralFS process.
